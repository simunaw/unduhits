                    ...
                    <table class="table table-hover table-vcenter">
                        <thead>
                            <tr>
                                ...
                                <th class="d-none d-sm-table-cell" style="width: 50%;">Url Link</th>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <a href="filedownloadMathematica/editMathematica/{{$pd->id}}" >
                                                <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                            </a>
                                        </button>
                                        <form action="filedownloadMathematica/destroyMathematica/{{$pd->id}}" method="POST">
                                            @method('delete')
                                            @csrf
                        ...
                        @foreach($file_installer as $fi)
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <a href="filedownloadMathematica/editMathematicaFI/{{$fi->id}}" >
                                                <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                            </a>
                                        </button>
                                        <form action="filedownloadMathematica/destroyMathematicaFI/{{$fi->id}}" method="POST">
                                            @method('delete')
                                            @csrf
                                            <button onclick="return confirm('Are you sure?')"  type="submit" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Delete">
                                                <i style="color:#EF5350" class="fa fa-times"></i>
