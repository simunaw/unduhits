    ...
    <div class="content">
        ...
        <div class="block">
                ...
                <div class="block-content">
                    <a href="/admin/matlab/ringkasanMatlab/createMatlab" class="btn btn-md btn-success mb-3">TAMBAH RINGKASAN</a>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <a href="/admin/matlab/ringkasanMatlab/editMatlab/{{$r->id}}" >
                                                <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                            </a>
                                        </button>
                                        <form action="/admin/matlab/ringkasanMatlab/destroyMatlab/{{$r->id}}" method="POST">
                                            @method('delete')
                                            @csrf
