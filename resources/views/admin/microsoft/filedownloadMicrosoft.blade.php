    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="block-content">
                <a href="/admin/microsoft/filedownloadMicrosoft/createMicrosoftFI" class="btn btn-md btn-success mb-3">TAMBAH FILE INSTALLER</a>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                        <a href="filedownloadMicrosoft/editMicrosoftFI/{{$fi->id}}" >
                                            <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                        </a>
                                    </button>
                                    <form action="filedownloadMicrosoft/destroyMicrosoftFI/{{$fi->id}}" method="POST">
                                        @method('delete')
                                        @csrf
