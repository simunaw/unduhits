    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Edit Persyaratan Sistem Adobe</h3>
            </div>
            <div class="block-content">
                <form action="/admin/microsoft/spesifikasiMicrosoft/updateMicrosoftPS/{{$persyaratan_sistem->id}}" method="POST" >
                    @method('PUT')
                    @csrf
